...
button.addEventListener("click",()=>{
   let random = Math.floor( Math.random() * quotes.length ); 
    ...
    h2.innerText = quotes[random].motivation;
    h3.innerText = quotes[random].surname;
    h4.innerText = quotes[random].id;
    h5.innerText = quotes[random].year;
    h6.innerText = quotes[random].category;
});
